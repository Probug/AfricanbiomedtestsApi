...
namespace Africanbiomedtests.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class HealthcareProviderController : BaseController
    {
        private readonly IHealthcareProviderService _accountService;
        private readonly IMapper _mapper;

        public HealthcareProviderController(
            IHealthcareProviderService accountService,
            IMapper mapper)
        {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<HealthcareProviderAccountResponse>> GetAll()
        {
